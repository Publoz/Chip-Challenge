...
public class XMLSaveLoad {
  ...
  public static Game load(String fileName) throws IOException {
    ...
    try {
      ...
      Document doc = sax
          .build(new File("./src/nz/ac/vuw/ecs/swen225/gp21/Persistency/levels/" + fileName));
  ...
  public static void save(Game game, String outputFileName) throws IOException {
    ...
    FileOutputStream fos = new FileOutputStream(
        "./src/nz/ac/vuw/ecs/swen225/gp21/Persistency/levels/" + outputFileName);
    try {
  ...
  public static Class loadClass() throws IOException {
    ...
    try {
      URL url = new URL(
          "jar:file:./src/nz/ac/vuw/ecs/swen225/gp21/Persistency/levels/Level2.jar!/");
